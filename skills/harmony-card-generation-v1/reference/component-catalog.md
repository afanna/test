...
- `children`: string array or template object
- `itemMargin`: number, vp
- `justifyContent`: `start|center|end|spaceAround|spaceBetween|spaceEvenly`
...
```json
{"id":"title","component":"Text","content":{"path":"/title"},"styles":{"fontSize":16,"fontWeight":"bold","fontColor":"#FFFFFFFF","maxLines":1,"textOverflow":"ellipsis"}}
```

Common styles:

- `fontSize`: number, fp
- `fontWeight`: number `100..900`; local templates also use `medium` and `bold`
