...
- Supported physical targets are `2x2` (`160 x 160vp`) and horizontal `2x4` (`320 x 160vp`).
...
- Usually 2 to 4 main zones arranged as side-by-side panes within the same `160vp` height.
