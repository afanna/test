...
If the host runtime requires responsive width, `styles.width` may be `"100%"`, but the composition must still fit the selected width budget: `160vp` for `2x2`, `320vp` for horizontal `2x4`.
...
- `2x4`: root `width: 320`, `height: 160`, root padding `10` to `12`, 2 to 4 main zones arranged horizontally.
...
- [ ] Root fits either `160 x 160vp` or horizontal `320 x 160vp`.
