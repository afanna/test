...
Use this after the validator passes. All fixes must use HarmonyOS GenUI extended styles and components.

## Compact Card Checks

- The card answers one glanceable question.
- The chosen size is explicit: `2x2` (`160 x 160vp`) or horizontal `2x4` (`320 x 160vp`).
...
- Root dimensions fit the selected target. If width is `"100%"`, the internal layout still respects `160vp` for `2x2` or `320vp` for horizontal `2x4`.
