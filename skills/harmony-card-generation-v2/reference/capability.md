...
Use for compact vertical cards that need more depth but still remain a card:

- A small stacked schedule.
- A richer care/advisory card.
- A product/device card with media plus state.
- A progress card with 2 to 3 supporting details.
...
- Width budget: `160vp`.
- Height budget: `160vp` for `2x2`, `320vp` for `2x4`.
