...
```json
{"id":"title","component":"Text","content":{"path":"/title"},"styles":{"fontSize":16,"fontWeight":"bold","fontColor":"#FFFFFFFF","maxLines":1,"textOverflow":"none"}}
```

Common styles:

- `fontSize`: number, fp
- `fontWeight`: number `100..900`; GenUI examples also use `medium` and `bold`
